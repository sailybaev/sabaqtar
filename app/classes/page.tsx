    ...
    <div className="bg-white flex h-[982px] w-[1512px]">
      ...
      <div className="flex flex-col h-[982px] w-[1256px]">
        ...
        <div className="flex flex-col gap-8 items-center pb-[10px] pt-10 px-10 shrink-0 w-full">
          ...
          <div className="flex flex-wrap gap-8 items-start w-[792px]">
            {filtered.length > 0 ? filtered.map((cls) => (
              <Link key={cls.name} href={cls.href}>
                <div className="border border-[rgba(0,0,0,0.15)] flex flex-col gap-4 h-[261px] items-start max-h-[261px] overflow-hidden px-2 py-4 rounded-[12px] w-[380px] hover:border-[#497fff] hover:bg-[rgba(73,127,255,0.02)] transition-colors cursor-pointer">
