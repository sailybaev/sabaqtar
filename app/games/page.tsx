        ...
        <div className="flex flex-col flex-1 min-h-0 px-10 pt-8 pb-6 gap-6">
          ...
          <div className="grid grid-cols-3 gap-4 overflow-y-auto">
            {filtered.length > 0 ? filtered.map((game) => (
              ...
              >
                <div className="w-14 h-14 rounded-[12px] bg-[#f0f4ff] flex items-center justify-center group-hover:bg-[#dce8ff] transition-colors relative">
                  <Gamepad2 size={28} className="text-[#497fff]" strokeWidth={1.5} />
